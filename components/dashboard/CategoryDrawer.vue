  ...
  >
    <div class="space-y-10 py-4">
      ...
      <div class="flex flex-col items-center gap-4 py-6 bg-gray-50 rounded-[2rem] border border-gray-100 shadow-inner relative overflow-hidden group/upload">
        ...
        >
          ...
          <div v-else class="text-center">
            ...
            <p class="text-[9px] font-black text-gray-400 mt-1 uppercase tracking-widest">Icon</p>
          </div>
        ...
        <div class="text-center relative z-10">
          ...
          <p class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-1">PNG or JPG • Max 2MB</p>
        </div>
      </div>
      ...
      <div v-if="uploading" class="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100/50">
        ...
        <p class="text-[10px] font-black text-[#065fdb] uppercase tracking-widest">Processing Image...</p>
      </div>
    </div>

    <template #footer>
      <div class="flex items-center gap-4 w-full">
        <button @click="$emit('close')" class="flex-1 py-4 bg-white border border-gray-100 text-gray-400 text-[10px] font-black uppercase tracking-widest rounded-2xl">Cancel</button>
        <button 
          @click="handleSubmit" 
