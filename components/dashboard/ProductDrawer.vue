  ...
  >
    <div class="space-y-10 py-2">
      ...
      <section class="space-y-4">
        <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.15em] flex items-center gap-2 px-1">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          >
             ...
             <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Add Photo</p>
    ...
    <template #footer>
      <div class="flex items-center gap-4 w-full">
        <button @click="$emit('close')" class="flex-1 py-4 bg-white border border-gray-100 text-gray-400 text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-gray-50 hover:text-gray-900 transition-all">Cancel</button>
        <button @click="handleSubmit" :disabled="uploading" class="flex-[2] py-4 bg-gray-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl hover:bg-black transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2">
