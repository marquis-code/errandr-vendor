<template>
 ...
 <div class="w-16 h-16 bg-gray-50 rounded-md flex items-center justify-center mb-6">
 ...
 :key="item._id || idx" 
 class="hover:bg-gray-50/80 transition-all group border-b border-gray-200 last:border-0"
 >
 <td 
 v-for="col in columns" 
 :key="col.key" 
