  ...
  <div class="relative" ref="containerRef">
    ...
    >
      ...
      <div class="flex-1 min-w-0">
        <p v-if="label" class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">{{ label }}</p>
    ...
    <Transition name="picker-fade">
      <div v-if="open" class="absolute z-50 top-full left-0 right-0 mt-2 bg-white rounded-2xl border border-gray-200 shadow-2xl shadow-gray-900/10 overflow-hidden" style="min-width: 260px;">
        ...
        <div class="bg-[#065fdb] px-5 py-4 flex items-center justify-between">
          <div>
            <p class="text-[10px] font-bold text-white/60 uppercase tracking-widest">Select Time</p>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-t border-gray-100 bg-gray-50/50">
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="confirmTime" class="px-6 py-2.5 bg-[#065fdb] text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:brightness-110 transition-all shadow-md shadow-[#065fdb]/20">Confirm</button>
          </div>
        </div>
      </div>
    </Transition>
