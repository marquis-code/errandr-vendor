<template>
 ...
 empty-subtitle="You haven't received any orders yet. If you're new, make sure to complete your profile setup."
 >
 ...
 <div class="bg-amber-50/40 rounded-[2.5rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)] relative overflow-hidden group border border-amber-100/20">
 <div class="relative z-10">
...
const fetchDashboardData = async () => {
 ...
 performanceStats.value[3].value = Number(s.rating || 5).toFixed(1);
 } catch (e) {
