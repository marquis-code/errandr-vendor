<template>
 ...
 class="px-8 py-4 bg-gray-900 text-white rounded-2xl font-black text-sm  shadow-xl shadow-black/10 hover:bg-black active:scale-95 transition-all flex items-center gap-2"
 >
 ...
 <span class="text-sm font-black ">Available for Withdrawal</span>
 </div>
 <div class="flex items-baseline gap-3">
 <span class="text-3xl font-black text-gray-300">₦</span>
 <h2 class="text-7xl font-black text-gray-900">{{ balance?.toLocaleString() || '0' }}</h2>
 </div>
 ...
 <div class="space-y-8">
 <div class="space-y-1">
 <p class="text-sm font-black text-gray-400 ">Total Earned</p>
 <p class="text-2xl font-black text-gray-900">₦{{ wallet?.totalEarned?.toLocaleString() || '0' }}</p>
 </div>
 <div class="space-y-1">
 <p class="text-sm font-black text-gray-400 ">Monthly Growth</p>
 ...
 <p class="text-sm font-black text-white/40 ">Active Settlement</p>
 ...
 <NuxtLink to="/dashboard/settings" class="text-sm text-blue-400 font-black  mt-2 block hover:underline">Configure Now</NuxtLink>
 </div>
 </div>

 <div class="mt-10 pt-8 border-t border-white/5 space-y-4 relative z-10">
 <div class="flex justify-between items-center text-sm font-black  text-white/40">
 <span>Cycle</span>
 ...
 <div class="space-y-1">
 <h3 class="text-xl font-black text-gray-900">Financial Timeline</h3>
 ...
 <button class="px-4 py-1.5 rounded-lg text-sm font-black  bg-white text-gray-900 shadow-sm">All</button>
 <button class="px-4 py-1.5 rounded-lg text-sm font-black  text-gray-400 hover:text-gray-600 transition-colors">Credits</button>
 <button class="px-4 py-1.5 rounded-lg text-sm font-black  text-gray-400 hover:text-gray-600 transition-colors">Payouts</button>
 </div>
 </div>
 </div>
 ...
 <template #type="{ item }">
 <span 
 class="px-3 py-1 rounded-lg text-sm font-black "
 ...
 <p class="text-sm font-black text-gray-400  mb-1">Current Balance</p>
 <p class="text-4xl font-black text-gray-900">₦{{ balance?.toLocaleString() }}</p>
 </div>
 </div>
 ...
 <button @click="showWithdrawModal = false" class="flex-1 py-4 bg-white border border-gray-100 text-gray-400 text-sm font-black  rounded-2xl">Cancel</button>
 <button 
