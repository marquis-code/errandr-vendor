<template>
 ...
 <h2 class="text-2xl font-medium text-white">Let's set up your store</h2>
 ...
 <h2 class="text-2xl font-medium text-white">Pre-order Setup</h2>
 ...
 <h2 class="text-2xl font-medium text-white">Final Touch</h2>
