    ...
    <div class="max-w-xl w-full space-y-8">
      ...
      <div class="glass p-8 rounded-3xl border-white/5 relative overflow-hidden">
        ...
        <div v-if="step === 1" class="space-y-6 animate-fade-in">
          ...
          <div class="space-y-4">
            <div>
              <label class="block text-[10px] font-bold text-dark-500 uppercase tracking-widest mb-2">Store Name</label>
              <input v-model="form.storeName" type="text" class="glass-input w-full p-4" placeholder="e.g. Tunde's Tasty Treats" />
            </div>
            <div>
              <label class="block text-[10px] font-bold text-dark-500 uppercase tracking-widest mb-2">Store Description</label>
        ...
        <div v-if="step === 2" class="space-y-6 animate-fade-in">
          ...
          <div class="space-y-6">
            ...
            <div v-if="form.preOrderOnly">
              <label class="block text-[10px] font-bold text-dark-500 uppercase tracking-widest mb-2">Preparation Lead Time (Hours)</label>
        ...
        <div v-if="step === 3" class="space-y-6 animate-fade-in">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-3 p-4 bg-primary-500/5 rounded-2xl border border-primary-500/10">
              ...
              <p class="text-[10px] text-primary-400 font-bold leading-tight uppercase tracking-wider">You are joining as a Student Entrepreneur. Listing is 100% free.</p>
            </div>
          </div>
        </div>
        ...
        <div class="flex gap-4 mt-8">
          ...
          <button @click="nextStep" class="flex-[2] btn-primary py-4 rounded-xl text-sm font-bold uppercase tracking-widest">
