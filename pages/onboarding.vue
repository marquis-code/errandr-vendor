<template>
 ...
 class="h-1 flex-1 rounded-md transition-all duration-500"
 :class="step >= i ? 'bg-primary-500 (var(--primary-),0.5)]' : 'bg-white/10'"
 />
 </div>

 <!-- Step Content -->
 <div class="glass p-8 rounded-md border-white/5 relative overflow-hidden">
 <div class="absolute -top-20 -left-20 w-64 h-64 bg-primary-500/5 rounded-md blur-3xl" />
 
 <!-- Step 1: Basic Info -->
 <div v-if="step === 1" class="space-y-6 animate-fade-in">
 <div class="text-center space-y-2 mb-8">
 <div class="w-16 h-16 bg-primary-500/20 text-primary-400 rounded-md flex items-center justify-center mx-auto mb-4">
 ...
 <h2 class="text-xl font-medium text-white">Let's set up your store</h2>
 ...
 <div class="text-center space-y-2 mb-8">
 <div class="w-16 h-16 bg-accent-500/20 text-accent-400 rounded-md flex items-center justify-center mx-auto mb-4">
 ...
 <h2 class="text-xl font-medium text-white">Pre-order Setup</h2>
 <p class="text-dark-400 text-sm">Do you need time to prepare your items?</p>
 </div>

 <div class="space-y-6">
 <div class="flex items-center justify-between p-4 glass rounded-md border-white/5 cursor-pointer hover:border-primary-500/30 transition-all" @click="form.preOrderOnly = !form.preOrderOnly">
 <div>
 <p class="text-sm font-bold text-white">Pre-order Only</p>
 <p class="text-sm text-dark-500">Customers must order in advance.</p>
 </div>
 <div class="w-12 h-6 rounded-md relative transition-colors duration-300" :class="form.preOrderOnly ? 'bg-primary-500' : 'bg-dark-800'">
 <div class="absolute top-1 left-1 w-4 h-4 bg-white rounded-md transition-transform duration-300" :class="form.preOrderOnly ? 'translate-x-6' : ''" />
 </div>
 </div>
 ...
 <div class="text-center space-y-2 mb-8">
 <div class="w-16 h-16 bg-green-500/20 text-green-400 rounded-md flex items-center justify-center mx-auto mb-4">
 ...
 <h2 class="text-xl font-medium text-white">Final Touch</h2>
 <p class="text-dark-400 text-sm">You're almost there! Let's verify your student status.</p>
 </div>

 <div class="space-y-4">
 <div class="p-6 border border-dashed border-white/10 rounded-md text-center hover:border-primary-500/30 transition-all cursor-pointer">
 ...
 <div class="flex items-center gap-3 p-4 bg-primary-500/5 rounded-md border border-primary-500/10">
 ...
 <button v-if="step > 1" @click="step--" class="flex-1 py-4 glass rounded-md text-sm font-bold text-dark-400 hover:text-white transition-all">Back</button>
 <button @click="nextStep" class="flex-[2] btn-primary py-2 rounded-md text-sm font-bold">
